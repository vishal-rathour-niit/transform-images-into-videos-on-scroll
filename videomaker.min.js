			...
			createPreImage: async function() {
				...
				l.forEach(function(t, a) {
					...
					f.loadImage(r, n).then(function() {
						0 === m && (f.event('start'), onMethod.call(this,{'status':'start','view':resizeManage.isDesktop ? 'desktopView':'mobileView'})), 
						m += 1, 
						u === m && (f.event('end') , onMethod.call(this,{'status':'end','view':resizeManage.isDesktop ? 'desktopView':'mobileView'}))
